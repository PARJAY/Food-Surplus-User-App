...
import com.example.tryuserapp.data.repository.YayasanRepository
import com.example.tryuserapp.data.repository.YayasanRepositoryImpl
...
interface AppModule {
    ...
    val yayasanRepositoryImpl : YayasanRepositoryImpl
